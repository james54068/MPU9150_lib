...
This lib is done by modify Harinadha's repository!!!!!!!

============================================================================
    For More details, visit: http://harinadha.wordpress.com
============================================================================

The MPU9150 I2C Device Library provideS simple and intuitive interfaces to MPU9150 I2C device on ARM 32-bit STM32F103xx family of microcontrollers.It has the I2C bit- and byte-level communication for complete coverage of all functionality described by MPU9150 documentation.
